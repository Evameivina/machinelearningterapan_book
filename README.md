...
Metrik Precision@K cocok digunakan untuk mengukur kualitas rekomendasi buku karena menekankan pada relevansi item di posisi teratas rekomendasi yang penting bagi pengalaman pengguna.

Hasil evaluasi menunjukkan bahwa content-based filtering mampu memberikan rekomendasi yang relevan sebagian, sehingga dapat digunakan sebagai baseline. Untuk peningkatan, langkah selanjutnya dapat dilakukan tuning fitur, eksplorasi metode hybrid dengan collaborative filtering, atau penerapan teknik pembobotan dan filter tambahan untuk meningkatkan relevansi rekomendasi.

---

### Contoh kode singkat perhitungan Precision@K
...
# Contoh evaluasi Precision@5 untuk satu buku
recommended_books = ['bookA', 'bookB', 'bookC', 'bookD', 'bookE']
relevant_books = ['bookB', 'bookF', 'bookG']

print(f"Precision@5: {precision_at_k(recommended_books, relevant_books, 5)}")
